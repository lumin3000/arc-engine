...
typedef enum {
  ...
  SHADER_TYPE_TERRAIN_HARD,
  SHADER_TYPE_TERRAIN_FADE,
  SHADER_TYPE_TERRAIN_FADE_ROUGH,
  SHADER_TYPE_TERRAIN_WATER,
  SHADER_TYPE_TERRAIN_WATER_MOVING,

  SHADER_TYPE_TERRAIN_HARD_POLLUTED,
  SHADER_TYPE_TERRAIN_FADE_POLLUTED,
  SHADER_TYPE_TERRAIN_FADE_ROUGH_POLLUTED,
